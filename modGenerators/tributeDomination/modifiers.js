...
// - planet attributes ( i.e "paradise" planets will obviously have some dosh)
// - number of links ( more links = more trade routes )
// - owner faction ( some factions will / can pay more or less )
// - mineables in the area ( small increase )
// - trade fleets in the area ( more trade ships must mean it's more profitable? )
